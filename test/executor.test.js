...
const TEST_AGENT = 'rs-demorg-enrops';
...
test('配置校验并按 host、port 生成固定回程 URL', () => {
  ...
  assert.deepEqual(
    readConfig(baseEnv),
    { agent: TEST_AGENT, port: 18033, ingressHost: '127.0.0.1', ingressPort: 29876, ingressToken: 'test', ingressTimeoutMs: 5000, ingressUrl: 'http://127.0.0.1:29876/agent/send' }
  );
